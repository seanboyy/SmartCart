# SmartCart
A simple, lightweight transportation plugin for MineCraft.  No powered rails required!  [Download It Now!](https://github.com/seanboyy/SmartCart/releases/download/1.2.0/SmartCart.jar)
